...
static void rt_ringbuffer_init(struct rt_ringbuffer *rb, rt_uint8_t * pool, rt_int16_t size);
static rt_size_t rt_ringbuffer_putchar(struct rt_ringbuffer *rb, const rt_uint8_t ch);
static rt_size_t rt_ringbuffer_getchar(struct rt_ringbuffer *rb, rt_uint8_t *ch);
...
void bsp_usart_finsh_init(void)
{
    //gpio prot config
